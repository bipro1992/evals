...
from .utils.prompt_templates import generate_case_template as CASE_SYSTEM_PROMPT
from .utils.prompt_templates import generate_rubric_template as RUBRIC_SYSTEM_PROMPT
